...
public class XMLUtil {
    ...
    public static List<Element> getElements(String tagName, List<Element> elements) {
        ...
        return elements.stream().filter((element) -> Objects.equals(element.getName(), tagName)).collect(Collectors.toList());
    }
    ...
    public static Element createElement(String tagName, Map<String, String> attributes) {
        ...
        attributes.forEach((key, value) -> element.addAttribute(key, value));
        return element;
    }
